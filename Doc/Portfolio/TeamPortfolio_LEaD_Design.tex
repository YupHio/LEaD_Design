...
Discussion on initial budget, estimated cost for materials, components, labor, and spending plan are all described below.
		...
		{\renewcommand\labelitemi{}
			...
			\begin{itemize}
				...
				Adruino's main sheild for commincation wireless is the Xbee sheild, thus since the underlying hardware is using Arduino, this was the only possible choice, the price of this hardware is somewhat high, due the company Arduino having some higher pricing, but it is an essential part of the hardware.
