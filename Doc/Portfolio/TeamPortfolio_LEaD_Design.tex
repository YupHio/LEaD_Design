...
%      \includegraphics[width=0.45\linewidth]{icon for team goes here}
  ...
  {\huge\bfseries LEaD Design: \\ Team Portfolio\par}
    ...
    \author{%
    	\makebox[.3\linewidth]{\Large\itshape Adrian Beehner}\\Contributor\\
    	\and \makebox[.3\linewidth]{\Large\itshape Andrew Butler}\\Contributor\\
    	\and \\ \makebox[.3\linewidth]{\Large\itshape Kevin Dorscher}\\Contributor\\
    	\and \\ \makebox[.3\linewidth]{\Large\itshape Paul Martin}\\Contributor\\
    }
